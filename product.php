...
<?php
    ...
    // $sql = "SELECT transactionId FROM cart ORDER BY transactionId desc limit 0,1 ";
...
<form action="product.php" method="GET">
    <div class="flex-container" style="background-color:#f2f2f2; justify-content: center;">
        ...
        <div>&nbsp</div>
        <div class="input--style-2" style="padding:2px; border: 2px solid #000000;">
            <input class="input--style-2" type="text" placeholder="   Cari Nama" name="nama" style="font-style:italic">
        </div>
        <!-- <div>&nbsp</div>
        <div class="input--style-2" style="padding:2px; border: 2px solid #000000;">
...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        echo $mySku;
        echo $myPromoPrice;
        $sql = "INSERT INTO cart (userId, sku, harga)
                VALUES ('$ID', '$mySku', '$myPromoPrice')";
        $result = mysqli_query($conn,$sql);
        if ($result) {
